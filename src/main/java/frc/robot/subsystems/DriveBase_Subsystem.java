...
public class DriveBase_Subsystem extends Subsystem {
	...
	//	An algorithm developed by the fantastic Sarah C. Lincoln that adjusts the joy
	...
	public void rampArcadeDrive(Joystick jackBlack) {
		...
		hotWheels.arcadeDrive(newDriveSpeed, turnJoystick); //negatie turn for 2018 robot
	}
